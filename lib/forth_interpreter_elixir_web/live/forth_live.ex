          ...
          <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
            ...
            <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
              <%= for execution <- @history do %>
                <tr>
                  <td class="px-6 py-4 whitespace-pre-wrap text-sm text-gray-900 dark:text-gray-100">
                    {execution.input}
                  </td>
                  <td class="px-6 py-4 whitespace-pre-wrap text-sm text-gray-500 dark:text-gray-400">
                    {inspect(execution.result, charlists: :as_lists)}
                  </td>
